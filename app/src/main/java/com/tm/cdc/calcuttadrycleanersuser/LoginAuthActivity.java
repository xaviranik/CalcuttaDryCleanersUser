...
public class LoginAuthActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        if (extras != null) {
            userPhoneNumber = extras.getString("PHONE_NUM");
        }
        ...
        mSendButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v)
            {
                ...
                if(buttonType == 0)
                {
                    ...
                    PhoneAuthProvider.getInstance().verifyPhoneNumber(phoneNum,60, TimeUnit.SECONDS, LoginAuthActivity.this, mCallback);
                }
                else
                {
                    mProgressBar.setVisibility(View.VISIBLE);
                    ...
                    .addOnCompleteListener(this, new OnCompleteListener<AuthResult>() {
                        ...
                        public void onComplete(@NonNull Task<AuthResult> task)
                        {
                            if(task.isSuccessful())
                            {
                                errorGroup.setVisibility(View.INVISIBLE);
                                mProgressBar.setVisibility(View.INVISIBLE);
                                startActivity(new Intent(LoginAuthActivity.this, LoginInfoCheckerActivity.class));
                                finish();
                            }
                            else
                            {
